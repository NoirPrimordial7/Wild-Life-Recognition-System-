...
# Load animal information from JSON
...
def identify_animal():
    ...
    result_label.configure(text=f"Predicted: {predicted_animal} (Confidence: {confidence:.2f})")
...
info_label = Label(root, text="", font=("Arial", 12), wraplength=500, justify="left")
